 ...
 */
@WifiFragmentScope
public class WifiFragmentViewModelFactory implements ViewModelProvider.Factory {
    ...
    @Inject
    WifiFragmentViewModelFactory(StorableResultRepository repository) {
    ...
    public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
        ...
        if (modelClass.isAssignableFrom(WifiFragmentViewModel.class)) {
            return (T) new WifiFragmentViewModel(repository, id);
        } else {
